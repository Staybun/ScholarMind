...
public class MilvusConstants {
     ...
     * Milvus 集合名称
     */
    public static final String MILVUS_COLLECTION_NAME = "scholarmind_paper_chunks";
    
    /**
     * 向量维度（DashScope text-embedding-v4 默认维度）
     */
     ...
     * Content字段最大长度
     */
    public static final int CONTENT_MAX_LENGTH = 12000;
